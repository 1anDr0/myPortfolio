...
import { FaNodeJs, FaGitAlt, FaGithub, FaBootstrap } from "react-icons/fa";
...
const MySkills = () => {
  ...
  return (
    <section className="bg-[#BAD8B6] text-[#1C1C1C] py-6 pl-[300px] pr-[820px] pb-[200px] ">
      ...
      <h1 className="text-[96px] font-medium tracking-[-0.07em] leading-[1.1] text-left w-full" style={{ fontFamily: "Helvetica, sans-serif" }}>
      ...
      <div className="w-full border-t border-b border-[#1C1C1C] mt-10" >
        ...
        >
          <span>Frontend</span>
          <span className={`text-[48px] transform transition-transform duration-500 ${isOpenFrontend ? 'rotate-[-45deg]' : 'rotate-0'}`}>
  <FiArrowDownLeft />
</span>
        ...
        <div
          className={`overflow-hidden transition-all duration-500 ease-in-out ${
            isOpenFrontend ? "max-h-[1000px] opacity-100 py-6" : "max-h-0 opacity-0"
          }`}
        >
          <div
          ...
          >
            ...
            <div className="flex justify-end space-x-4 mt-4 py-10 ">
              <FaHtml5 className="w-[44px] h-[44px]"  />
              <FaCss3Alt className="w-[44px] h-[44px]" />
              <FaJsSquare className="w-[44px] h-[44px]" />
              <FaReact className="w-[44px] h-[44px]" />
              <FaNodeJs className="w-[44px] h-[44px]" />
              <FaGitAlt className="w-[44px] h-[44px]" />
              <FaGithub className="w-[44px] h-[44px]" />
              <SiTailwindcss className="w-[44px] h-[44px]" />
              <FaBootstrap className="w-[44px] h-[44px]" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full border-t border-b border-[#1C1C1C] mt-12">
        ...
        >
          <span className={`text-[48px]  transform transition-transform duration-500 ${isOpenDesign ? 'rotate-45' : 'rotate-0'}`}><FiArrowDownRight /></span>
          <span>Design</span>
        </button>
        <div
          className={`overflow-hidden transition-all duration-500 ease-in-out ${
        ...
        >
          ...
          >
            ...
            <div className="flex justify-start space-x-4 mt-6 py-10">
              <FaFigma className="w-[44px] h-[44px]" />
              <SiAdobexd className="w-[44px] h-[44px]" />
              <SiAdobephotoshop className="w-[44px] h-[44px]" />
              <SiAdobeillustrator className="w-[44px] h-[44px]" />
              <SiAdobeindesign className="w-[44px] h-[44px]" />
              <SiMiro className="w-[44px] h-[44px]" />
            </div>
          </div>
        </div>
      </div>
