...
const Hero = () => {
  ...
  return (
    <section className="animate-fadeIn relative bg-[#FDFDFD] text-[#1C1C1C] min-h-screen flex flex-col pl-[300px] pt-[250px] pb-[100px] overflow-hidden">

      <img
        src={figmaImage}
        alt="Jerka Danielsson"
        className="absolute right-[300px] top-[160px] w-[400px] h-auto object-cover rounded-full z-10 motion-safe:transform motion-safe:transition-transform motion-safe:duration-5000 hover:scale-105"
      />
<img
  src={rectangleImage}
  alt="Blur Overlay 1"
  className="absolute top-0 left-0 w-full h-[350px] z-20 hover:opacity-20 transition-opacity duration-1000 ease-in-out pointer-events-auto"
/>

<img
  src={rectangleImage}
  alt="Blur Overlay 2"
  className="absolute top-[220px] left-0 w-full h-[530px] z-20 hover:opacity-20 transition-opacity duration-1000 ease-in-out pointer-events-auto"
/>
      ...
      <div className="w-[190px] h-[2px] bg-[#1C1C1C] mb-6 z-10 animate-fadeInSlow"></div>
...
>
  ...
  <span className="absolute left-0 top-0 opacity-0 group-hover:opacity-100 transition-opacity duration-1000 ease-in-out">
    Hej! Jag heter Jerker Danielsson.
      ...
      <h2 className="text-[48px] font-light leading-[100%] tracking-[-0.07em] mt-4 z-10">
        STUDENT @ JENSEN EDUCATION
      </h2>
      <h3 className="text-[48px] font-light leading-[100%] tracking-[-0.07em] mt-2 z-10">
        (FRONT-END DEVELOPER)
      </h3>

      <div className="w-full max-w-[780px] border-t border-b border-[#1C1C1C] mt-10 z-30">
        <button
          className="w-full flex justify-between items-center py-1 text-[24px] font-medium tracking-[-0.02em] cursor-pointer"
...
>
  <p
    className="text-[20px] leading-[1.5] max-w-[800px]"
    style={{ fontFamily: "Helvetica, sans-serif" }}
  >
  ...
  <a
    ...
    download
    className="border-2 border-[#1C1C1C] text-[#1C1C1C] mt-10 bg-white h-[44px] px-4 w-fit rounded-full text-[44px] font-medium tracking-tight flex items-center justify-center transition-all duration-300 hover:bg-[#1C1C1C] hover:text-white"
    style={{ fontFamily: "Helvetica, sans-serif" }}
