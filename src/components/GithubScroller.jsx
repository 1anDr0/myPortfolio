...
const GithubScroller = () => {
  ...
  return (
    <div
      className={`hidden 2xl:flex fixed  lg:-left-10 xl:left-0 2xl:left-10 fixed left-16 xl:left-10 top-[550px] hidden lg:flex z-50 flex-col items-center transition-opacity duration-500 ease-in-out ${
